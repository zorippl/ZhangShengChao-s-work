...
/**
 * @brief ESP32-S3-Box Lite LCD GPIO defination and config
 * 
 */
...
/**
 * @brief ESP32-S3-Box Lite I2C GPIO defineation
 * 
 */
...
/**
 * @brief ESP32-S3-Box Lite SDMMC GPIO defination
 * 
...
/**
 * @brief ESP32-S3-Box Lite SDSPI GPIO definationv
 * 
 */
...
/**
 * @brief ESP32-S3-Box Lite SPI GPIO defination
 * 
 */
...
/**
 * @brief ESP32-S3-Box Lite RMT GPIO defination
 * 
 */
...
/**
 * @brief ESP32-S3-Box Lite I2S GPIO defination
 * 
 */
...
/**
 * @brief ESP32-S3-Box Lite power control IO
 * 
